...
namespace CERRS.Plugins.MCRJournalOnPhCallCreate
{
    public abstract partial class BasePlugin 
    {
        ...
        public void WebClientPlugin(string config)
        {
            ...
            {
                webAddress = "https://cerrsdev.crm9.dynamics.com";
            }
            else
            {
                webAddress = config;
    ...
    public struct EntityNames
    {
        ...
        public static readonly string cog_application = "cog_application";
        public static readonly string cog_case = "cog_case";
        public static readonly string cog_caseassignees = "cog_caseassignees";
        public static readonly string cog_caseclosurebatch = "cog_caseclosurebatch";
        public static readonly string cog_casestatushistory = "cog_casestatushistory";
        public static readonly string cog_categorizednotes = "cog_categorizednotes";
        public static readonly string cog_cog_application_cog_case = "cog_cog_application_cog_case";
        public static readonly string cog_cog_case_cog_identifier = "cog_cog_case_cog_identifier";
        public static readonly string cog_cog_caseclosurebatch_cog_case = "cog_cog_caseclosurebatch_cog_case";
        public static readonly string cog_cogsetting = "cog_cogsetting";
        public static readonly string cog_dataremediation = "cog_dataremediation";
        public static readonly string cog_disputeerror = "cog_disputeerror";
        public static readonly string cog_entityassignmentrules = "cog_entityassignmentrules";
        public static readonly string cog_identifier = "cog_identifier";
        public static readonly string cog_mcrlog = "cog_mcrlog";
        public static readonly string cog_mcrpostrequest = "cog_mcrpostrequest";
        public static readonly string cog_reportdefinition = "cog_reportdefinition";
        public static readonly string cog_reportexecutionsession = "cog_reportexecutionsession";
        public static readonly string cog_reportprocess = "cog_reportprocess";
        public static readonly string cog_reportsessionparam = "cog_reportsessionparam";
        public static readonly string cog_reprintrequest = "cog_reprintrequest";
        public static readonly string cog_timelineactivity = "cog_timelineactivity";
        public static readonly string cog_workbookrequest = "cog_workbookrequest";
    ...
    public struct MessageNames
    {
        ...
        public static readonly string BulkOperationStatusClose = "BulkOperationStatusClose";
        ...
        public static readonly string CleanUpBulkOperation = "CleanUpBulkOperation";
        public static readonly string Clone = "Clone";
        public static readonly string CloneProduct = "CloneProduct";
        public static readonly string Close = "Close";
        public static readonly string cog_PopulateStates = "cog_PopulateStates";
        ...
        public static readonly string LogFailure = "LogFailure";
        public static readonly string LogSuccess = "LogSuccess";
        ...
        public static readonly string ProcessOneMemberBulkOperation = "ProcessOneMemberBulkOperation";
        ...
        public static readonly string StatusUpdateBulkOperation = "StatusUpdateBulkOperation";
        ...
        public static readonly string VerifyProcessStateData = "VerifyProcessStateData";
